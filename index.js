...
// ============ DISCORD BOT TOKEN (HARDCODE - HATI-HATI!) ============
const DISCORD_TOKEN = 'MTQ5MjQ2NjMyNzI1MDY2NTU1Mg.G11iqX.Re2m4UItAobqHAxtl7UhoZpImwsSbZbAEL1ds8';  // <-- GANTI INI!
  ...
  bot.once('spawn', () => {
    ...
    setTimeout(() => {
      try {
        ...
        console.log(`🛡️ Guarding spawn area`);
      } catch(e) {}
    }, 5000);
  });
...
discordClient.once('ready', () => {
  ...
  console.log(`🤖 Spectre Panel is ready! Use /panel in Discord`);
});
